...
To start the application run the command to`npm install` install the required packages  and  `npm start` to make the project  available at [http://localhost:3000/](http://localhost:3000/).
